...
const API_KEY = 'cd7364ff304963033e25da89d9498d3d';
...
const getFormattedWeatherData = async (searchParams) => {
    ...
    const formattedForecastWeather = await getWeatherData("forecast/hourly", { lat, lon, exclude: "current,minutely,alerts", units: searchParams.units }).then(formatForecastWeather);
